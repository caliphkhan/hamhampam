        ...
        if ( !$checkTemplate ) {
            \DB::table('email_templates')->insert(
                array (
                    ...
                    href="https://www.facebook.com/"><img src="'. url('/public/assets/image/facebook.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;"
                    href="https://twitter.com/?lang=en"><img src="'. url('/public/assets/image/twitter.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px;display: inline-block; "
                    href="https://www.instagram.com/?hl=en"><img src="'. url('/public/assets/image/instagram.png') .'"
                    alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block; "
                    href="https://www.whatsapp.com/"><img src="'. url('/public/assets/image/whatsapp.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;"
                    href="https://www.pioneer.eu/"><img src="'. url('/public/assets/image/pinterest.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block; "
                    href="https://www.youtube.com/"><img src="'. url('/public/assets/image/youtube.png') .'" alt="" /></a>
                    </div>
                    <p style="border-top: 1px solid #dfdfdf;margin: 1px 20px 0px 20px; "></p>
                    </td>
                    </tr>
        ...
        if ( !$checkTemplate ) {
            \DB::table('email_templates')->insert(
                array (
                    ...
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://www.facebook.com/"><img src="'. url('/public/assets/image/facebook.png') .'" alt=""/></a>
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://twitter.com/?lang=en"><img src="'. url('/public/assets/image/twitter.png') .'" alt=""/></a>
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://www.instagram.com/?hl=en"><img src="'. url('/public/assets/image/instagram.png') .'" alt="" /></a>
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://www.whatsapp.com/"><img src="'. url('/public/assets/image/whatsapp.png') .'" alt=""/></a>
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://www.pioneer.eu/"> <img style="margin: -2px;" src="'. url('/public/assets/image/pinterest.png') .'" alt="" /></a>
                    <a class="anchor-tag "style="margin-right: 9px; width: 32px; height:32px; display: inline-block;" href="https://www.youtube.com/"><img style="margin: 1px;" src='. url('/public/assets/image/youtube.png') .'" alt=""/></a>
                    </div>
                    <p style="border-top: 1px solid #dfdfdf; margin: 1px 20px 0px 20px;"></p>
                    </td>
                    </tr>
        ...
        if (!$checkTemplate) {
            \DB::table('email_templates')->insert(
                array (
                    ...
                    <div style=" margin-top: 32px; margin-bottom:31px;">
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.facebook.com/"><img src="'. url('/public/assets/image/facebook.png') .'" alt=""/></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://twitter.com/?lang=en"><img src="'. url('/public/assets/image/twitter.png') .'" alt=""/> </a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.instagram.com/?hl=en"><img src="'. url('/public/assets/image/instagram.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.whatsapp.com/"><img src="'. url('/public/assets/image/whatsapp.png') .'" alt=""/></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.pioneer.eu/"> <img src="'. url('/public/assets/image/pinterest.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;"  href="https://www.youtube.com/"><img src='. url('/public/assets/image/youtube.png') .'" alt=""/></a>
                    </div>
                    <p style="border-top: 1px solid #dfdfdf; margin: 1px 20px 0px 20px;"></p>
                    </td>
                    </tr>
        ...
        if (!$checkTemplate) {
            ...
            \DB::table('email_templates')->insert(
                array (
                    ...
                    src="'. url('/public/assets/image/pinterest.png') .'" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; height:32px; display: inline-block;"
                    href="https://www.youtube.com/"><img style="margin: 1px;" src='. url('/public/assets/image/youtube.png') .'"
                    alt="" /></a>
                    </div>
                    <p style="border-top: 1px solid #dfdfdf; margin: 1px 20px 0px 20px;"></p>
                    </td>
        ...
        if (!$checkTemplate) {
            \DB::table('email_templates')->insert(
                array (
                    ...
                    href="https://www.facebook.com/"><img src="'. url('/public/assets/image/facebook.png') .'"
                    alt="" /></a>
                    <a class="anchor-tag"
                    style="margin-right: 9px; width: 32px; height:32px; display: inline-block;"
                    href="https://twitter.com/?lang=en"><img src="'. url('/public/assets/image/twitter.png') .'"
                    alt="" /></a>
                    <a class="anchor-tag"
                    style="margin-right: 9px; width: 32px; height:32px; display: inline-block;"
                    href="https://www.instagram.com/?hl=en"><img
                    src="'. url('/public/assets/image/instagram.png') .'" alt="" /></a>
                    <a class="anchor-tag"
                    style="margin-right: 9px; width: 32px; height:32px; display: inline-block;"
                    href="https://www.whatsapp.com/"><img src="'. url('/public/assets/image/whatsapp.png') .'"
                    alt="" /></a>
                    <a class="anchor-tag"
                    style="margin-right: 9px; width: 32px; height:32px; display: inline-block;"
                    href="https://www.pioneer.eu/"> <img style="margin: -2px;"
                    ...
                    src='. url('/public/assets/image/youtube.png') .'" alt="" /></a>
                    </div>
                    <p style="border-top: 1px solid #dfdfdf; margin: 1px 20px 0px 20px;"></p>
                    </td>
                    </tr>
        ...
        if ( !$checkTemplate ) {
            \DB::table('email_templates')->insert(
                array (
                    ...
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.instagram.com/?hl=en"><img src="' . url('/public/assets/image/instagram.png')  . '" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.whatsapp.com/"><img src="' . url('/public/assets/image/whatsapp.png')  . '" alt=""/></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;" href="https://www.pioneer.eu/"> <img style="margin: -2px;" src="' . url('/public/assets/image/pinterest.png') . '" alt="" /></a>
                    <a class="anchor-tag" style="margin-right: 9px; width: 32px; display: inline-block;"  href="https://www.youtube.com/"><img src="' . url('/public/assets/image/youtube.png')  . '" alt=""/></a>
                    </div>
