...
$('.lang').on('click', function() {
    if (is_demo) {
        $('.top-notification').removeClass('d-none').find('.alert').addClass('alert-info').removeClass('alert-success').find('.alertText').text(jsLang("Demo Mode! This action can't be perform."));
        return;
    }
